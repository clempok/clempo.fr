...
export default function InfluenceursSanteForm({
  variant = 'full',
  theme = 'light',
  source = 'influenceurs-sante',
  onSubmitted,
}: Props) {
    ...
    return (
      <div style={{
        ...
        <p style={{
          ...
          Bon usage de cette base. J'explique comment activer concrètement ces créateurs dans{' '}
          <a
            href="https://avotresante.substack.com/"
            target="_blank"
        ...
        <a
          href={INFLUENCEURS_SANTE_SHEET_URL}
          target="_blank"
          rel="noopener noreferrer"
          style={{
  ...
  return (
    <div style={wrapperStyle}>
      ...
      <form name="influenceurs-sante" onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
        <input type="hidden" name="form-name" value="influenceurs-sante" />
...
export function InfluenceursSanteNetlifyRegistration() {
  return (
    <form name="influenceurs-sante" data-netlify="true" hidden>
      <input type="hidden" name="form-name" value="influenceurs-sante" />
