...
<p>À noter : c'est l'une des rares spécialités où <strong>Doctolib n'est PAS présent comme logiciel de gestion</strong> (uniquement comme plateforme de RDV). Le marché reste donc disputé par les éditeurs spécialisés.</p>`,
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    topPlayers: [
      ...
      { rank: 3, name: 'Smart RX FES', editor: 'Smart RX', share: '11,1%', note: 'nouvelle gamme FES' },
      { rank: 4, name: 'Leo 2.0', editor: 'CERP Rouen', share: '7,5%' },
      { rank: 5, name: 'Logiphar FES', editor: 'Smart RX', share: '1,8%' },
    ],
    marketAnalysis: `<p>Le logiciel pharmacie le plus utilisé en France est <strong>ID. (LGPI)</strong>, édité par <strong>Equasens</strong> (anciennement Pharmagest, leader historique français), avec <strong>40,0%</strong> des télétransmissions en mars 2026 — soit 2 pharmacies sur 5. C'est une part de marché stable depuis 7 ans (40% en 2019, 40% en 2026).</p>
<p>Le numéro 2 est <strong>Winpharma</strong>, édité par <strong>Everys</strong>, avec 36,2% du marché — en très forte progression depuis 2019 où il ne représentait que 21%. À eux deux, LGPI et Winpharma équipent <strong>76% des pharmacies françaises</strong> — c'est l'un des marchés les plus duopolistiques de la santé libérale.</p>
<p>Le top 5 est complété par <strong>Smart RX FES</strong> (Smart RX, 11,1% — la nouvelle gamme FES Feuille de Soins Electronique du groupe), <strong>Leo 2.0</strong> (CERP Rouen, 7,5%) et <strong>Logiphar FES</strong> (1,8%). Le reste du marché est marginal : Caduciel, Periphar, Opus représentent moins de 1% chacun.</p>`,
...
<p>Un facteur clé : la <strong>politique de financement des centres de santé</strong> par l'État (avec exigences de reporting accru) et le développement des centres pluri-professionnels (CPTS, MSP) ont rebattu les cartes. Les centres ont besoin de solutions cloud capables d'agréger les données de tous les praticiens — d'où le succès de Veasy et Intellio Editeurs.</p>`,
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    marketAnalysis: `<p>Le logiciel laboratoire d'analyses le plus utilisé en France est <strong>Hexalis</strong>, édité par <strong>Dedalus Healthcare France</strong>, avec <strong>32,0%</strong> des télétransmissions en mars 2026. C'est le leader stable du marché LIMS (Laboratory Information Management System) français depuis plus de 10 ans, avec une part qui n'a quasiment pas bougé sur la période 2019-2026 (de 33,1% à 32,0%).</p>
<p>Le numéro 2 est <strong>Clarilab</strong>, édité par <strong>Clarisys Informatique</strong>, avec 6,0% du marché — en progression depuis 2019 où il ne représentait que 2,5%. Le reste du top est marginal.</p>
<p>Particularité unique de ce marché : <strong>"Autres" représente 62% des laboratoires</strong> — c'est de loin le plus fragmenté de toutes les spécialités santé. Cela s'explique par la nature très technique du métier (LIMS = système d'information complexe intégré aux automates d'analyse) et la prédominance des éditeurs hyper-spécialisés non répertoriés dans les données GIE SESAM-Vitale, ainsi que par la forte concentration capitalistique des labos (groupes Synlab, Cerba, Biogroup, Eurofins, Laborizon, Inovie…) qui utilisent leurs propres solutions internes.</p>`,
    trends: `<p>La grande tendance du marché LIMS biologie médicale 2019-2026, c'est la <strong>disparition de Progimed FSE</strong> (Dedalus Healthcare France), qui est passé de 23,8% à 0% en 7 ans. Dedalus a migré ses utilisateurs Progimed vers <strong>Hexalis</strong>, qui reste leader stable à 32%.</p>
<p>Côté concurrents, <strong>Clarilab</strong> a doublé sa part (de 2,5% à 6,0%) — porté par sa positioning "challenger indépendant" face au géant Dedalus. <strong>DX Lab One</strong> (Dedalus) a aussi disparu, signe que Dedalus consolide son offre autour d'Hexalis.</p>
<p>La vraie tendance de fond, c'est la <strong>concentration capitalistique</strong> du secteur biologie médicale française, avec les méga-fusions (Cerba, Synlab, Biogroup, Inovie, Laborizon, Eurofins…) qui imposent leurs propres systèmes d'information internes. Cela explique pourquoi 62% des laboratoires utilisent des solutions non répertoriées dans les données SESAM-Vitale — il s'agit majoritairement de SI propriétaires des grands groupes ou d'éditeurs hyper-spécialisés (Sysmex, Roche Diagnostics, Cepheid…) intégrés directement aux automates.</p>`,
    faq: [
      {
        q: "Quel est le logiciel laboratoire d'analyses biomédicales le plus utilisé en France ?",
        a: "Hexalis (édité par Dedalus Healthcare France) est le logiciel LIMS le plus utilisé par les laboratoires d'analyses biomédicales français en 2026, avec 32,0% des télétransmissions. Il est suivi par Clarilab (Clarisys Informatique, 6,0%), mais une majorité de laboratoires (62%) utilisent des solutions non répertoriées (SI internes des grands groupes, éditeurs hyper-spécialisés).",
      },
      {
        q: "Qu'est-ce qu'un LIMS et à quoi sert-il en laboratoire ?",
        a: "Un LIMS (Laboratory Information Management System), aussi appelé SGL (Système de Gestion de Laboratoire) en français, est un logiciel qui pilote l'ensemble du circuit d'analyse en biologie médicale : enregistrement patient, prélèvement, paillasse, validation biologique, télétransmission des résultats au médecin prescripteur et à l'Assurance Maladie. C'est un outil critique car il assure la traçabilité réglementaire (norme ISO 15189) de chaque analyse.",
      },
      {
        q: 'Pourquoi 62% des laboratoires utilisent un logiciel non répertorié ?',
        a: "Le marché de la biologie médicale française est fortement consolidé autour de mega-groupes (Cerba HealthCare, Synlab, Biogroup, Inovie, Laborizon, Eurofins…) qui ont chacun développé leur propre système d'information interne. Ces SI propriétaires ne sont pas comptabilisés dans les statistiques publiques des éditeurs commerciaux. À cela s'ajoutent les solutions hyper-spécialisées intégrées aux automates d'analyse (Sysmex, Roche Diagnostics, Cepheid…), ce qui explique la part élevée de la catégorie 'Autres'.",
      },
    ],
  },
]
