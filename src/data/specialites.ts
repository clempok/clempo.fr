...
<p>La tendance de fond est claire : <strong>cloud > on-premise</strong>, <strong>intégration RDV/téléconsultation > logiciel pur</strong>, et <strong>UX moderne > legacy Windows</strong>. Les éditeurs qui n'ont pas migré vers le SaaS dans les délais ont perdu massivement.</p>`,
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    asOf: 'juin 2026',
    topPlayers: [
      { rank: 1, name: 'Logos_w', editor: 'Imagex', share: '45,9%', note: 'leader depuis 2023, +0,7 pt au T2 2026' },
      { rank: 2, name: 'Julie', editor: 'Julie Solutions (groupe Imagex depuis 2026)', share: '19,7%', note: 'leader historique, racheté à Henry Schein One' },
    ...
    marketAnalysis: `<p>Le logiciel dentaire le plus utilisé en France est <strong>Logos_w</strong>, édité par <strong>Imagex</strong> (Liffré), qui représente <strong>45,9%</strong> des télétransmissions en juin 2026 — soit près d'un cabinet dentaire sur deux. Il a doublé Julie en 2023 et son avance ne cesse de se creuser (+0,7 point sur le seul 2e trimestre 2026).</p>
<p>Le numéro 2 historique reste <strong>Julie</strong> (Julie Solutions, plus de 20 000 utilisateurs revendiqués) avec 19,7% des cabinets — repassé sous la barre des 20% et 12 points de moins qu'en 2019 (il était alors à 32%). Fait majeur du marché : <strong>Imagex a racheté Julie Solutions à Henry Schein One en 2026</strong>, créant de fait un groupe combiné qui pèse ~65% du parc dentaire français en télétransmission. Le top 5 du marché est complété par <strong>CS Trophy Gestion</strong> (Carestream Dental, 7,0%), <strong>WeClever Dental</strong> (Dentalvia-Medilor, 5,2%) et <strong>Veasy</strong> (la solution cloud de Visiodent, 4,3% — au niveau du groupe Visiodent, ce sont 10 000 dentistes et 500 centres de santé qui sont équipés tous produits confondus).</p>
    ...
    faq: [
      {
        ...
        a: "Logos_w (édité par Imagex) est le logiciel dentaire le plus utilisé par les chirurgiens-dentistes français en 2026, avec 45,9% des télétransmissions en juin — devant Julie (19,7%), CS Trophy Gestion (7,0%), WeClever Dental (5,2%) et Veasy (4,3%).",
      },
      {
