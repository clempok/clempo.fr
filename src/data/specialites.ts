...
<p>Côté éditeurs, le marché est partagé entre <strong>Doctolib</strong> (23%), <strong>Cegedim Santé</strong> (Crossway, MonLogicielMedical.com, MEDICLICK — ~16% cumulés), <strong>CompuGroup Medical</strong> (HelloDoc + AxiSanté via CGM eVITALE, ~15% cumulés), <strong>Vidal France</strong> (Weda, 14%) et <strong>Olaqin</strong> (Stellair, 7%). À noter que Doctolib s'est imposé sans rachat — uniquement via une stratégie d'intégration logicielle native à sa plateforme de prise de RDV.</p>`,
    trends: `<p>En 7 ans, le marché du logiciel médecin généraliste a été <strong>complètement bouleversé</strong>. Le leader historique <strong>HelloDoc</strong> est passé de 18,4% à 8,1% (-10 points). <strong>AxiSanté</strong> (CompuGroup Medical) est passé de 16% en 2019 à 6,8% en 2026 — une perte de près de la moitié de sa base, mais pas un effondrement : l'éditeur a migré ses utilisateurs du module de facturation AxiAM vers le nouveau module CGM eVITALE, et l'essentiel du parc télétransmet désormais via cette nouvelle brique.</p>
<p>Les grands gagnants : <strong>Doctolib</strong> (de 0% à 23,2% en 5 ans), <strong>Weda</strong> (de 0% à 14% — porté par son modèle SaaS cloud) et <strong>Stellair Integral</strong> d'Olaqin (de 0% à 7,3%).</p>
...
<p>Le top 5 du marché IDEL est complété par <a href="https://www.albus.fr/" target="_blank" rel="noopener"><strong>Albus AIR</strong></a> (Sofia Développement, 17,1% — la nouvelle gamme cloud du groupe), <strong>Simply-Vitale</strong> (Cegedim Santé, 12,3%), <strong>Vega</strong> (Epsilog, 10,6%) et <strong>Soins 2000</strong> (Logisur'M, 9,4%). Ces 5 solutions couvrent à elles seules 82,5% du marché — le reste se partage entre une douzaine d'éditeurs plus marginaux.</p>
...
<p>Le top 5 est complété par <strong>Medi+4000</strong> (Cegedim Santé, 19,5%), <strong>Doctolib</strong> (14,9% — entré sur le marché kiné en 2021), <strong>Maiia Gestion</strong> (Cegedim Santé, 10,7% — lancé en 2024) et <a href="https://www.topaze.com/" target="_blank" rel="noopener"><strong>Topaze AIR</strong></a> (Sofia Développement, 3,6%). Ces cinq solutions couvrent 90,7% du marché kiné — c'est l'un des marchés les plus concentrés du paysage libéral.</p>
...
<p>Le top 5 est complété par <strong>Vega</strong> (Epsilog, 20,6%), <strong>Medi+4000</strong> (Cegedim Santé, 18,7%), <a href="https://www.orthomax.fr/" target="_blank" rel="noopener"><strong>Orthomax</strong></a> (Sofia Développement, 13,7%) et <strong>Topaze AIR</strong> (Sofia Développement, 4,2%). Ces 5 solutions couvrent 89% du marché orthophoniste français.</p>
