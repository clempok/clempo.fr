...
export const specialites: Specialite[] = [
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    metaDescription: "Quel logiciel médical est le plus utilisé par les généralistes en France ? Doctolib (26%), Weda (13%), Medistory (10%), HelloDoc (8%). Classement à jour, données GIE SESAM-Vitale.",
    source: 'GIE SESAM-Vitale',
    asOf: 'juin 2026',
    topPlayers: [
      { rank: 1, name: 'Doctolib', editor: 'Doctolib', share: '26,2%', note: 'leader depuis fin 2024, +3 pts au T2 2026' },
      { rank: 2, name: 'Weda', editor: 'Vidal France', share: '13,4%', note: 'logiciel cloud' },
      { rank: 3, name: 'Medistory', editor: 'Prokov Editions', share: '10,1%', note: 'historiquement Mac' },
      { rank: 4, name: 'HelloDoc', editor: 'Imagine Editions', share: '7,6%', note: "leader historique jusqu'en 2023" },
      { rank: 5, name: 'Stellair Integral', editor: 'Olaqin', share: '7,2%' },
    ],
    marketAnalysis: `<p>Le logiciel le plus utilisé par les médecins généralistes français est <strong>Doctolib</strong>, qui équipe environ <strong>26,2%</strong> des cabinets en juin 2026 (mesuré sur les feuilles de soins électroniques télétransmises au GIE SESAM-Vitale). Doctolib a pris la première place fin 2024 en passant devant <strong>Weda</strong> (édité par Vidal France) qui détient désormais 13,4% du marché — et il accélère encore : +3 points sur le seul 2e trimestre 2026.</p>
<p>Le top 5 des logiciels médecin généraliste les plus utilisés en France se complète par <strong>Medistory</strong> (Prokov Editions, 10,1% — l'historique référence Mac), <strong>HelloDoc</strong> (Imagine Editions, 7,6%) et <strong>Stellair Integral</strong> (Olaqin, 7,2%). Ensemble, ces cinq solutions couvrent près de 65% du marché — le reste étant fragmenté entre une vingtaine d'éditeurs (AxiSanté, Dr Santé, Crossway, Intellio, MonLogicielMedical.com…).</p>
<p>Côté éditeurs, le marché est partagé entre <strong>Doctolib</strong> (26%), <strong>CompuGroup Medical</strong> (HelloDoc + AxiSanté via CGM eVITALE, ~14% cumulés), <strong>Vidal France</strong> (Weda, 13%), <strong>Cegedim Santé</strong> (Crossway, MonLogicielMedical.com, MEDICLICK — ~10% cumulés) et <strong>Olaqin</strong> (Stellair, 7%). À noter que Doctolib s'est imposé sans rachat — uniquement via une stratégie d'intégration logicielle native à sa plateforme de prise de RDV.</p>`,
    trends: `<p>En 7 ans, le marché du logiciel médecin généraliste a été <strong>complètement bouleversé</strong>. Le leader historique <strong>HelloDoc</strong> est passé de 18,4% à 7,6% (-11 points). <strong>AxiSanté</strong> (CompuGroup Medical) est passé de 16% en 2019 à 6,5% en 2026 — une perte de près de la moitié de sa base, mais pas un effondrement : l'éditeur a migré ses utilisateurs du module de facturation AxiAM vers le nouveau module CGM eVITALE, et l'essentiel du parc télétransmet désormais via cette nouvelle brique.</p>
<p>Les grands gagnants : <strong>Doctolib</strong> (de 0% à 26,2% en 6 ans — dont +3 points sur le seul 2e trimestre 2026), <strong>Weda</strong> (de 0% à 13,4% — porté par son modèle SaaS cloud) et <strong>Stellair Integral</strong> d'Olaqin (de 0% à 7,2%).</p>
<p>La tendance de fond est claire : <strong>cloud > on-premise</strong>, <strong>intégration RDV/téléconsultation > logiciel pur</strong>, et <strong>UX moderne > legacy Windows</strong>. Les éditeurs qui n'ont pas migré vers le SaaS dans les délais ont perdu massivement.</p>`,
    faq: [
      {
        ...
        a: "Doctolib est le logiciel le plus utilisé par les médecins généralistes français en 2026, avec 26,2% des télétransmissions en juin. Il est suivi par Weda (13,4%), Medistory (10,1%), HelloDoc (7,6%) et Stellair Integral (7,2%).",
      },
      {
        q: 'AxiSanté est-il toujours utilisé par les médecins généralistes ?',
        a: "Oui. AxiSanté (édité par CompuGroup Medical) est utilisé par 6,5% des médecins généralistes télétransmettant en juin 2026, soit le 6e logiciel du marché. Sa part a baissé depuis 2019 (16%), notamment au profit de Doctolib et Weda, mais le produit reste actif — l'éditeur a simplement migré ses utilisateurs de l'ancien module de facturation AxiAM vers le nouveau CGM eVITALE en 2024.",
      },
      {
        q: 'Quelle est la part de marché de Doctolib dans le logiciel médecin ?',
        a: "Doctolib représente 26,2% des télétransmissions des médecins généralistes en France en juin 2026, ce qui en fait le numéro 1 du marché. La société a démarré son logiciel de gestion de cabinet en 2020 et a gagné plus de 26 points de parts de marché en 6 ans — dont 3 points sur le seul 2e trimestre 2026.",
      },
    ],
  },
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    metaDescription: "Quel logiciel dentaire est le plus utilisé en France ? Logos_w (46%) a pris la 1re place à Julie (20%), suivi par CS Trophy, WeClever, Veasy. Données GIE SESAM-Vitale.",
    source: 'GIE SESAM-Vitale',
    asOf: 'juin 2026',
    topPlayers: [
      { rank: 1, name: 'Logos_w', editor: 'Logjia (ex-Imagex)', share: '45,9%', note: 'leader depuis 2023, +0,7 pt au T2 2026' },
      { rank: 2, name: 'Julie', editor: 'Logjia (ex-Henry Schein One)', share: '19,7%', note: 'leader historique, réuni avec Logos_w dans Logjia en 2026' },
      { rank: 3, name: 'CS Trophy Gestion', editor: 'Carestream Dental', share: '7,0%' },
      { rank: 4, name: 'WeClever Dental', editor: 'Dentalvia-Medilor', share: '5,2%' },
      { rank: 5, name: 'Veasy', editor: 'Visiodent', share: '4,3%', note: 'nouvelle gamme cloud Visiodent' },
    ],
    marketAnalysis: `<p>Le logiciel dentaire le plus utilisé en France est <strong>Logos_w</strong>, édité par <strong>Logjia</strong> (ex-Imagex, Liffré), qui représente <strong>45,9%</strong> des télétransmissions en juin 2026 — soit près d'un cabinet dentaire sur deux. Il a doublé Julie en 2023 et son avance ne cesse de se creuser (+0,7 point sur le seul 2e trimestre 2026).</p>
<p>Le numéro 2 historique reste <strong>Julie</strong> (plus de 20 000 utilisateurs revendiqués) avec 19,7% des cabinets — repassé sous la barre des 20% et 12 points de moins qu'en 2019 (il était alors à 32%). Fait majeur du marché : <strong>au 1<sup>er</sup> janvier 2026, Logos_w, Julie et JULiA ont fusionné pour former le groupe <a href="https://www.information-dentaire.fr/actualites/logosw-julie-et-julia-deviennent-logjia/" target="_blank" rel="noopener">Logjia</a></strong> — le groupe Logos_w ayant racheté Julie et JULiA à Henry Schein One. Ce groupe combiné pèse désormais <strong>~66% du parc dentaire français</strong> en télétransmission. Le top 5 du marché est complété par <strong>CS Trophy Gestion</strong> (Carestream Dental, 7,0%), <strong>WeClever Dental</strong> (Dentalvia-Medilor, 5,2%) et <strong>Veasy</strong> (la solution cloud de Visiodent, 4,3% — au niveau du groupe Visiodent, ce sont 10 000 dentistes et 500 centres de santé qui sont équipés tous produits confondus).</p>
...
<p>Le cadre réglementaire français (HDS, INS depuis 2021, SESAM-Vitale, ADRi, Addendum 8, Mon espace santé/DMP, MSSanté, vague Ségur en cours) forme une barrière à l'entrée majeure : les nouveaux entrants ne peuvent plus attaquer frontalement le LGC, ils doivent passer par un wedge (cloud multi-sites, IA, intégration labo, conformité documentaire).</p>`,
    faq: [
      {
        ...
        a: "Logos_w (édité par Logjia, ex-Imagex) est le logiciel dentaire le plus utilisé par les chirurgiens-dentistes français en 2026, avec 45,9% des télétransmissions en juin — devant Julie (19,7%), CS Trophy Gestion (7,0%), WeClever Dental (5,2%) et Veasy (4,3%). Logos_w et Julie appartiennent désormais au même groupe, Logjia.",
      },
      {
        q: 'Julie est-il toujours utilisé par les dentistes ?',
        a: "Oui, Julie reste le numéro 2 du marché dentaire français avec 19,7% des cabinets en juin 2026, et plus de 20 000 utilisateurs revendiqués. Sa part a fortement reculé depuis 2019 (où il représentait 32% du marché), au profit principalement de Logos_w. Au 1er janvier 2026, Julie et JULiA ont été cédés par Henry Schein One au groupe Logos_w : les trois marques (Logos_w, Julie, JULiA) ont fusionné pour former le groupe Logjia. Julie reste commercialisé et maintenu, mais sous cette nouvelle entité.",
      },
      {
        q: 'Quels sont les principaux éditeurs de logiciels dentaires en France ?',
        a: "Sur la gestion de cabinet : Logjia (le groupe né en janvier 2026 de la fusion de Logos_w, Julie et JULiA), Visiodent / Veasy, Carestream Dental (CS Trophy), Dentalvia-Medilor (WeClever) et Maevi Systèmes. Sur l'imagerie 2D/3D : Planmeca (Romexis), Carestream (CS Imaging), DEXIS (DTX Studio), Owandy. Sur la CAO/FAO et le laboratoire : 3Shape, exocad (groupe Align), Dental Wings, Dentsply Sirona (inLab) en international, et Prothesis, Prothea, Logidents côté ERP français.",
      },
      {
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    asOf: 'juin 2026',
    topPlayers: [
      { rank: 1, name: 'Agathe YOU (E.Motion)', editor: 'CBA Informatique Libérale', share: '33,4%', note: 'leader incontesté' },
      { rank: 2, name: 'Albus AIR', editor: 'Sofia Développement', share: '17,4%', note: 'gamme cloud' },
      { rank: 3, name: 'Simply-Vitale', editor: 'Cegedim Santé', share: '12,2%' },
      { rank: 4, name: 'Vega', editor: 'Epsilog', share: '10,3%' },
      { rank: 5, name: 'Soins 2000', editor: "Logisur'M", share: '9,5%' },
    ],
    marketAnalysis: `<p>Le logiciel infirmier libéral le plus utilisé en France est <strong>Agathe YOU</strong> (gamme E.Motion), édité par <strong>CBA Informatique Libérale</strong>, avec <strong>33,4%</strong> des télétransmissions IDEL en juin 2026 — soit un infirmier libéral sur trois. C'est le seul progiciel à dépasser les 30% de parts de marché.</p>
<p>Le top 5 du marché IDEL est complété par <a href="https://www.albus.fr/" target="_blank" rel="noopener"><strong>Albus AIR</strong></a> (Sofia Développement, 17,4% — la nouvelle gamme cloud du groupe), <strong>Simply-Vitale</strong> (Cegedim Santé, 12,2%), <strong>Vega</strong> (Epsilog, 10,3%) et <strong>Soins 2000</strong> (Logisur'M, 9,5%). Ces 5 solutions couvrent à elles seules 82,7% du marché — le reste se partage entre une douzaine d'éditeurs plus marginaux.</p>
<p>Le marché du logiciel infirmier libéral est structuré autour de deux acteurs dominants : <strong>CBA Informatique Libérale</strong> (33% via Agathe YOU) et <strong>Sofia Développement</strong> (~22% en cumulant Albus AIR, Topaze AIR, et reliquat Topaze classique). Les besoins métier sont très spécifiques (tournées, dépendance, AIS/AMI) ce qui favorise les éditeurs spécialisés sur l'IDEL versus les éditeurs généralistes.</p>`,
    trends: `<p>Le marché infirmier connaît une <strong>migration générationnelle massive</strong> initiée par les éditeurs eux-mêmes. CBA a basculé sa base "AGATHE" historique (16% en 2019) vers <strong>Agathe YOU</strong> qui passe de 11% à 33,4% (+22 points). Sofia a opéré la même bascule sur sa gamme : <strong>ALBUS classique</strong> (4,2% → 0%), <strong>TOPAZE classique</strong> (4,4% → 0,5%) et <strong>INFIMAX</strong> ont tous été progressivement migrés vers les versions <strong>AIR</strong> (cloud).</p>
...
<p>À noter : <strong>Simply-Vitale</strong> (Cegedim) progresse régulièrement (de 8,3% à 12,2%) et capte une partie des utilisateurs déçus des migrations forcées chez les concurrents.</p>`,
    faq: [
      {
        q: 'Quel est le logiciel infirmier libéral le plus utilisé en France ?',
        a: "Agathe YOU (édité par CBA Informatique Libérale) est le logiciel infirmier libéral le plus utilisé en France en 2026, avec 33,4% des télétransmissions IDEL en juin. Il est suivi par Albus AIR (17,4%), Simply-Vitale (12,2%), Vega (10,3%) et Soins 2000 (9,5%).",
      },
      {
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    asOf: 'juin 2026',
    topPlayers: [
      { rank: 1, name: 'Vega', editor: 'Epsilog', share: '41,3%', note: 'leader stable' },
      { rank: 2, name: 'Medi+4000', editor: 'Cegedim Santé', share: '18,8%', note: 'forte érosion' },
      { rank: 3, name: 'Doctolib', editor: 'Doctolib', share: '16,3%', note: 'entrée 2021, +1,5 pt au T2 2026' },
      { rank: 4, name: 'Maiia Gestion', editor: 'Cegedim Santé', share: '10,9%', note: 'lancement 2024' },
      { rank: 5, name: 'Topaze AIR', editor: 'Sofia Développement', share: '4,0%' },
    ],
    marketAnalysis: `<p>Le logiciel kiné le plus utilisé en France est <strong>Vega</strong>, édité par <strong>Epsilog</strong>, avec <strong>41,3%</strong> des télétransmissions en juin 2026 — soit plus de 4 cabinets de masseurs-kinésithérapeutes sur 10. Il s'agit du leader historique du marché et il a même progressé légèrement sur la période (+1,8 point depuis 2019).</p>
<p>Le top 5 est complété par <strong>Medi+4000</strong> (Cegedim Santé, 18,8%), <strong>Doctolib</strong> (16,3% — entré sur le marché kiné en 2021, +1,5 point sur le seul 2e trimestre 2026), <strong>Maiia Gestion</strong> (Cegedim Santé, 10,9% — lancé en 2024) et <a href="https://www.topaze.com/" target="_blank" rel="noopener"><strong>Topaze AIR</strong></a> (Sofia Développement, 4,0%). Ces cinq solutions couvrent 91,4% du marché kiné — c'est l'un des marchés les plus concentrés du paysage libéral.</p>
<p>Côté éditeurs, deux acteurs structurent le marché : <strong>Epsilog</strong> (42% à eux seuls avec Vega) et <strong>Cegedim Santé</strong> (~30% en cumulant Medi+4000 et Maiia Gestion). <strong>Doctolib</strong> est le challenger qui monte : son intégration native avec la prise de RDV est un avantage compétitif fort sur cette spécialité où la file active patient est très importante.</p>`,
    trends: `<p>La grande tendance du marché kiné, c'est l'<strong>érosion de Medi+4000</strong> (Cegedim) qui est passé de 39,4% à 18,8% en 7 ans — soit plus de la moitié de sa base. Cegedim a tenté de récupérer ces utilisateurs avec sa nouvelle solution <strong>Maiia Gestion</strong> (lancée en 2024), qui capte déjà 10,9% du marché — soit quasiment la perte cumulée du groupe. L'éditeur a d'ailleurs <strong>recentré Maiia sur la cible kiné</strong>, au détriment des centres de santé et des médecins qu'il servait encore début 2025.</p>
<p>L'autre grand mouvement, c'est l'arrivée de <strong>Doctolib</strong> sur le marché kiné en 2021. La plateforme de prise de RDV a lancé une fonction logiciel de gestion intégrée et a capté <strong>16,3% du marché en 5 ans</strong> — un rythme de pénétration record, encore accéléré au 2e trimestre 2026 (+1,5 point). La logique : un kiné qui prend déjà ses RDV sur Doctolib n'a plus de friction à utiliser le module gestion intégré.</p>
<p>Les autres solutions historiques (Kinemax, Topaze classique) ont massivement perdu, en partie remplacées par les versions cloud (Topaze AIR) du même éditeur.</p>`,
    faq: [
      {
        ...
        a: "Vega (édité par Epsilog) est le logiciel le plus utilisé par les masseurs-kinésithérapeutes français en 2026, avec 41,3% des télétransmissions en juin. Il est suivi par Medi+4000 (Cegedim, 18,8%), Doctolib (16,3%), Maiia Gestion (Cegedim, 10,9%) et Topaze AIR (4,0%).",
      },
      {
        q: 'Doctolib propose-t-il un logiciel pour les kinés ?',
        a: "Oui, Doctolib propose un logiciel de gestion de cabinet kiné depuis 2021, intégré nativement à sa plateforme de prise de RDV. En 5 ans, il a capté 16,3% du marché kiné français (+1,5 point sur le seul 2e trimestre 2026), devenant le 3e logiciel le plus utilisé et se rapprochant de Medi+4000.",
      },
      {
        q: 'Vega est-il toujours numéro 1 du logiciel kiné ?',
        a: "Oui, Vega d'Epsilog est leader incontesté du marché kiné français depuis plus de 10 ans, avec 41,3% des cabinets en juin 2026 — et sa part a même légèrement progressé sur la période 2019-2026.",
      },
    ],
  },
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    asOf: 'juin 2026',
    topPlayers: [
      { rank: 1, name: 'Soins 2000', editor: "Logisur'M", share: '32,4%', note: 'leader depuis 2024' },
      { rank: 2, name: 'Vega', editor: 'Epsilog', share: '20,4%', note: 'ex-leader' },
      { rank: 3, name: 'Medi+4000', editor: 'Cegedim Santé', share: '18,4%', note: 'ex-leader' },
      { rank: 4, name: 'Orthomax', editor: 'Sofia Développement', share: '13,1%' },
      { rank: 5, name: 'Topaze AIR', editor: 'Sofia Développement', share: '4,9%' },
    ],
    marketAnalysis: `<p>Le logiciel le plus utilisé par les orthophonistes français est <strong>Soins 2000</strong>, édité par <strong>Logisur'M</strong>, avec <strong>32,4%</strong> des télétransmissions en juin 2026. C'est un changement majeur : Soins 2000 ne représentait que 5,6% du marché en 2019 — il a multiplié sa part par six en 7 ans.</p>
<p>Le top 5 est complété par <strong>Vega</strong> (Epsilog, 20,4%), <strong>Medi+4000</strong> (Cegedim Santé, 18,4%), <a href="https://www.orthomax.fr/" target="_blank" rel="noopener"><strong>Orthomax</strong></a> (Sofia Développement, 13,1%) et <strong>Topaze AIR</strong> (Sofia Développement, 4,9%). Ces 5 solutions couvrent 89% du marché orthophoniste français.</p>
<p>Le marché orthophoniste a la particularité d'être très concentré (top 3 = 71%) tout en étant assez stable côté nombre d'éditeurs (~22 progiciels actifs). Sofia Développement est l'éditeur dominant si on cumule Orthomax + Topaze AIR + autres (~22%). Logisur'M est le challenger qui s'est imposé en quelques années.</p>`,
    trends: `<p>Le marché orthophoniste a connu un <strong>renversement spectaculaire</strong>. En 2019, le duo de tête était <strong>Medi+4000</strong> (31,4%) et <strong>Vega</strong> (29,7%), qui se partageaient 61% du marché. En 2026, ils ont tous les deux fortement reculé : Medi+4000 à 18,4% (-13 points) et Vega à 20,4% (-9 points). Les utilisateurs déçus des deux ont massivement basculé vers <strong>Soins 2000</strong> de Logisur'M qui a capté +26 points sur la période.</p>
...
<p>À noter : c'est l'une des rares spécialités où <strong>Doctolib n'est PAS présent comme logiciel de gestion</strong> (uniquement comme plateforme de RDV). Le marché reste donc disputé par les éditeurs spécialisés.</p>`,
    faq: [
      {
        ...
        a: "Soins 2000 (édité par Logisur'M) est le logiciel le plus utilisé par les orthophonistes français en 2026, avec 32,4% des télétransmissions en juin. Il est suivi par Vega (Epsilog, 20,4%), Medi+4000 (Cegedim, 18,4%), Orthomax (Sofia, 13,1%) et Topaze AIR (4,9%).",
      },
      {
        q: 'Pourquoi Soins 2000 a-t-il pris la première place ?',
        a: "Soins 2000 (Logisur'M) est passé de 5,6% à 32,4% du marché orthophoniste entre 2019 et 2026. Cette croissance s'explique principalement par sa modernisation cloud + mobile en avance sur les acteurs historiques (Medi+4000 de Cegedim et Vega d'Epsilog), qui ont tardé à mettre à jour leurs solutions.",
      },
      {
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    asOf: 'juin 2026',
    topPlayers: [
      { rank: 1, name: 'ID. (LGPI)', editor: 'Equasens (ex-Pharmagest)', share: '39,9%', note: 'leader stable' },
      { rank: 2, name: 'Winpharma', editor: 'Everys', share: '36,7%', note: 'forte progression, +0,4 pt au T2 2026' },
      { rank: 3, name: 'Smart RX FES', editor: 'Smart RX (groupe Cegedim)', share: '10,4%', note: 'nouvelle gamme FES' },
      { rank: 4, name: 'Leo 2.0', editor: 'Isipharm (groupe Astera)', share: '7,7%' },
    ],
    marketAnalysis: `<p>Le logiciel pharmacie le plus utilisé en France est <strong>ID. (LGPI)</strong>, édité par <strong>Equasens</strong> (anciennement Pharmagest, leader historique français), avec <strong>39,9%</strong> des télétransmissions en juin 2026 — soit 2 pharmacies sur 5. C'est une part de marché remarquablement stable depuis 7 ans (40% en 2019, 40% en 2026). À l'échelle européenne, le groupe Equasens revendique plus de <strong>12 000 pharmacies équipées</strong> et une division Pharmagest Europe à <strong>163,5 M€</strong> de chiffre d'affaires en 2024.</p>
<p>Le numéro 2 est <strong>Winpharma</strong>, édité par <strong>Everys</strong>, avec 36,7% du marché — en très forte progression depuis 2019 où il ne représentait que 21% (et encore +0,4 point sur le 2e trimestre 2026). Everys revendique <strong>plus de 7 800 officines équipées</strong> (28,1 M€ de CA 2024). À eux deux, LGPI et Winpharma équipent <strong>77% des pharmacies françaises</strong> — c'est l'un des marchés les plus duopolistiques de la santé libérale, et l'écart entre les deux leaders continue de se réduire (3 points en juin 2026).</p>
<p>Le top 4 est complété par <strong>Smart RX FES</strong> (Smart RX, filiale du <strong>groupe Cegedim</strong>, 10,4% — la nouvelle gamme FES Feuille de Soins Electronique, 40,1 M€ de CA 2024, 15 agences en France) et <strong>Leo 2.0</strong> (édité par <strong>Isipharm</strong>, groupe Astera ex-CERP Rouen, 7,7%). Le reste du marché est marginal : Caduciel, Periphar, Opus représentent moins de 1% chacun, et l'ancienne gamme Logiphar FES a été entièrement absorbée par Smart RX FES.</p>
<p>Au-delà du top 5 GIE, le marché compte un <strong>long tail d'éditeurs français</strong> à plus petite échelle mais bien implantés : <strong>PharmaVitale</strong> (CEPI), <strong>Pharmaland</strong> (La Source Informatique), <strong>VisioPharm</strong>, <strong>Crystal</strong> (Infosoft, développé depuis 1994), <strong>Vindilis</strong> (créé en 2005) et <strong>Pharmony One</strong> (positionnement SaaS natif cloud). Ces éditeurs adressent souvent des niches (PDA, multi-sites, groupements, cloud natif) et coexistent avec les leaders sur un parc total de <strong>19 898 officines</strong> en France métropolitaine et DOM au 11 mai 2026 (source CNOP, en baisse de 253 officines sur un an). Le marché logiciel + services numériques d'officine se situe dans une fourchette de <strong>160 à 220 M€/an</strong>, dont <strong>90 à 130 M€</strong> de noyau LGO récurrent (estimation analytique).</p>`,
    trends: `<p>La grande tendance du marché pharmacie 2019-2026, c'est la <strong>montée en puissance de Winpharma</strong> (Everys), qui a gagné <strong>+16 points en 7 ans</strong> (de 21% à 36,7%). Cette progression s'est faite principalement aux dépens de l'ancien <strong>Alliance + FES</strong> de Smart RX (19,3% en 2019 → 0% en 2026), qui a été progressivement remplacé par la nouvelle gamme <strong>Smart RX FES</strong> (10,4%).</p>
...
<p>Sur le plan technique, trois forces structurent désormais le marché : (1) <strong>le socle Ségur</strong> (INS, DMP, DP, MSSanté, Mon espace santé, application carte Vitale, sérialisation France MVO, HDS, FHIR/CI-SIS) devient un coût produit continu, et non une vague de projets ponctuels ; (2) <strong>l'émergence du SaaS natif</strong> (Pharmony One, LEOcloud) challenge le modèle licence + maintenance traditionnel, particulièrement sur les officines multi-sites et les groupements ; (3) <strong>l'IA appliquée à la dispensation et au pilotage de stock</strong> émerge comme le prochain levier de différenciation pour les leaders, avec une exigence forte d'explicabilité et de cadre clinique.</p>`,
    faq: [
      {
        ...
        a: "ID. (LGPI), édité par Equasens (anciennement Pharmagest), est le logiciel pharmacie le plus utilisé en France en 2026, avec 39,9% des pharmacies en juin. Il est suivi par Winpharma (Everys, 36,7%), Smart RX FES (10,4%) et Leo 2.0 d'Isipharm (7,7%). À eux quatre, ils couvrent près de 95% du marché.",
      },
      {
      ...
      },
      {
        ...
        a: "LGPI (Equasens) reste légèrement en tête en juin 2026 avec 39,9% du marché, contre 36,7% pour Winpharma (Everys). L'écart se réduit chaque année — Winpharma a gagné 16 points depuis 2019 alors que LGPI s'est stabilisé, et l'écart n'est plus que de 3 points. Si la tendance se prolonge, Winpharma pourrait dépasser LGPI d'ici 2028.",
      },
      {
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    metaDescription: "Quel logiciel médical est le plus utilisé par les spécialistes en France ? Doctolib (17%), Xplore (11%), GXD5 RIS (8%), Stellair (6%), Intellio (5%). Marché fragmenté, données GIE SESAM-Vitale.",
    source: 'GIE SESAM-Vitale',
    asOf: 'juin 2026',
    topPlayers: [
      { rank: 1, name: 'Doctolib', editor: 'Doctolib', share: '16,5%', note: '1er logiciel identifié, +1,1 pt au T2 2026' },
      { rank: 2, name: 'Xplore', editor: 'EDL', share: '11,0%', note: 'forte présence imagerie' },
      { rank: 3, name: 'GXD5 RIS', editor: 'Enovacom', share: '8,0%', note: 'spécialités radio' },
      { rank: 4, name: 'Stellair Integral', editor: 'Olaqin', share: '5,7%', note: 'passe devant Intellio au T2 2026' },
      { rank: 5, name: 'Intellio', editor: 'Orisha Healthcare France', share: '5,2%', note: 'leader historique en recul' },
    ],
    marketAnalysis: `<p>Le logiciel le plus utilisé par les médecins spécialistes français (toutes spécialités confondues hors médecine générale) est <strong>Doctolib</strong>, qui équipe <strong>16,5%</strong> des cabinets en juin 2026. Fait notable du 2e trimestre 2026 : Doctolib (+1,1 point) est désormais passé <strong>devant la catégorie « Autres » (16,2%)</strong>, devenant pour la première fois le premier logiciel identifié du marché — et non plus seulement le premier éditeur nommé. Il a pris la tête en 2024, profitant du recul d'AxiSanté (CompuGroup) — passé de 10% à environ 3,7% — et de la migration d'une partie des ex-utilisateurs vers la solution intégrée à la prise de RDV.</p>
<p>Le top 5 est complété par <strong>Xplore</strong> (EDL, 11,0% — très utilisé en radiologie / imagerie médicale), <strong>GXD5 RIS</strong> (Enovacom, 8,0% — solution RIS spécialisée radiologie), <strong>Stellair Integral</strong> (Olaqin, 5,7% — passé devant Intellio au 2e trimestre 2026) et <strong>Intellio</strong> (Orisha Healthcare France, 5,2% — leader historique en perte de vitesse).</p>
<p>Le marché des médecins spécialistes est <strong>extrêmement fragmenté</strong> : "Autres" (éditeurs hors top 30) représente 16,2% des cabinets — bien plus que pour les généralistes (2,2%). Cette fragmentation s'explique par la diversité des spécialités : chaque discipline (radio, cardio, ophtalmo, dermato, gynéco…) a souvent ses propres éditeurs verticaux. C'est l'un des marchés les plus disputés de la santé libérale française.</p>`,
    trends: `<p>Le marché des médecins spécialistes a vu deux grandes ruptures en 7 ans. D'abord, le <strong>recul d'AxiSanté</strong> (CompuGroup Medical) qui est passé de 10,2% à environ 3,9% en 2026 — l'éditeur a migré ses utilisateurs du module de facturation AxiAM vers le nouveau CGM eVITALE, et perdu près des deux tiers de sa base au passage, principalement au profit de Doctolib. Deuxièmement, la <strong>conquête de Doctolib</strong> qui est passé de 0% à 16,5% (+1,1 point sur le seul 2e trimestre 2026), capitalisant sur sa plateforme RDV pour vendre son module logiciel intégré — au point de dépasser en juin 2026 la catégorie « Autres » et de devenir le premier logiciel identifié du marché.</p>
<p>Côté éditeurs spécialisés, <strong>Xplore</strong> (EDL) progresse régulièrement (+5,3 points) en consolidant sa position chez les radiologues. <strong>HelloDoc</strong> (Imagine Editions) recule fortement (-6 points), perdant des utilisateurs à Doctolib et AxiSanté (via CGM eVITALE). <strong>Intellio</strong> (Orisha) a perdu 6,6 points — symptôme du vieillissement de la solution face aux nouvelles offres cloud.</p>
<p>La tendance dominante est claire : les <strong>spécialités à forte composante imagerie/RIS</strong> (radio, imagerie, cardio interventionnelle) restent fidèles à des éditeurs verticaux (Xplore, GXD5 RIS), tandis que les <strong>spécialités cliniques classiques</strong> (gynéco, dermato, etc.) basculent vers Doctolib pour profiter de l'intégration RDV/téléconsultation.</p>`,
    faq: [
      {
        ...
        a: "Doctolib est le logiciel le plus utilisé par les médecins spécialistes français en 2026, avec 16,5% des télétransmissions en juin — il est même passé devant la catégorie « Autres » (16,2%) ce trimestre. Il est suivi par Xplore (EDL, 11,0%), GXD5 RIS (Enovacom, 8,0%), Stellair Integral (Olaqin, 5,7%) et Intellio (Orisha Healthcare, 5,2%).",
      },
      {
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    asOf: 'juin 2026',
    topPlayers: [
      { rank: 1, name: 'Cosium Center', editor: 'Cosium', share: '30,4%', note: 'leader stable' },
      { rank: 2, name: 'Optimum Live', editor: 'Optimum CIT', share: '21,9%', note: 'forte progression' },
      { rank: 3, name: 'MyEasyOptic', editor: 'Cristallin', share: '14,0%', note: 'arrivé en 2021' },
      { rank: 4, name: 'Seeneo', editor: 'GrandVision France', share: '6,1%', note: 'enseigne intégrée' },
      { rank: 5, name: 'Ivoirnet', editor: 'VerticalOptic', share: '4,8%' },
    ],
    marketAnalysis: `<p>Le logiciel opticien le plus utilisé en France est <strong>Cosium Center</strong>, édité par <strong>Cosium</strong>, avec <strong>30,4%</strong> des télétransmissions en juin 2026 — soit près d'un magasin d'optique sur trois. C'est le leader historique du marché et il a même progressé sur la période (+8 points depuis 2019).</p>
<p>Le top 5 est complété par <strong>Optimum Live</strong> (Optimum CIT, 21,9% — en forte croissance), <strong>MyEasyOptic</strong> (Cristallin, 14,0% — solution cloud arrivée en 2021), <strong>Seeneo</strong> (GrandVision France, 6,1% — solution intégrée à l'enseigne) et <strong>Ivoirnet</strong> (VerticalOptic, 4,8%).</p>
<p>Côté éditeurs, deux acteurs dominent : <strong>Cosium</strong> (30,4%) et <strong>Optimum CIT</strong> (21,9%). Le marché optique est particulier car il est très lié aux <strong>centrales d'achat et enseignes</strong> (Krys, Optic 2000, Atol, GrandVision, Afflelou…), ce qui structure les choix de logiciels — chaque enseigne tend à promouvoir une solution spécifique auprès de ses adhérents.</p>`,
...
<p><strong>Optimum Live</strong> a triplé sa part de marché (de 6,9% à 21,9%) — porté par sa solution SaaS et son intégration omnicanal (e-commerce, prise de RDV, téléconsultation). <strong>MyEasyOptic</strong> est arrivé sur le marché en 2021 et a directement capté 14,0% du marché en 5 ans, avec une stratégie cloud-first et mobile-first.</p>
<p>Côté enseignes, <strong>Synergie Optique</strong> (logiciel groupe GrandVision avant la fusion EssilorLuxottica) a disparu (-9 pts) au profit de <strong>Seeneo</strong>, le successeur. C'est un marché en pleine restructuration consolidée par 2-3 éditeurs cloud modernes.</p>`,
    faq: [
      {
        ...
        a: "Cosium Center (édité par Cosium) est le logiciel le plus utilisé par les opticiens français en 2026, avec 30,4% des télétransmissions en juin. Il est suivi par Optimum Live (21,9%), MyEasyOptic (14,0%), Seeneo de GrandVision (6,1%) et Ivoirnet (4,8%).",
      },
      {
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    metaDescription: "Quel logiciel audioprothésiste est le plus utilisé en France ? Cosium Center (44%), IDM Software (12%), Optimum Live (5%). Marché concentré, données GIE SESAM-Vitale.",
    source: 'GIE SESAM-Vitale',
    asOf: 'juin 2026',
    topPlayers: [
      { rank: 1, name: 'Cosium Center', editor: 'Cosium', share: '44,4%', note: 'leader incontesté' },
      { rank: 2, name: 'IDM Software', editor: 'IDM', share: '11,7%', note: 'spécialiste audio' },
      { rank: 3, name: 'Optimum Live', editor: 'Optimum CIT', share: '5,2%' },
      { rank: 4, name: 'Intellio Editeurs', editor: 'Orisha Healthcare France', share: '0,6%' },
      { rank: 5, name: 'MyEasyOptic', editor: 'Cristallin', share: '0,3%' },
    ],
    marketAnalysis: `<p>Le logiciel audioprothésiste le plus utilisé en France est <strong>Cosium Center</strong>, édité par <strong>Cosium</strong>, avec <strong>44,4%</strong> des télétransmissions en juin 2026 — soit près d'un audioprothésiste sur deux. Le même éditeur leader sur le marché optique a transposé son offre avec succès sur l'audiologie.</p>
<p>Le numéro 2 est <strong>IDM Software</strong> (édité par <strong>IDM</strong>), avec 11,7% — un spécialiste 100% audio bien implanté dans le métier. Le top 5 se complète par <strong>Optimum Live</strong> (Optimum CIT, 5,2%), <strong>Intellio Editeurs</strong> (Orisha Healthcare, 0,6%) et <strong>MyEasyOptic</strong> (Cristallin, 0,3% — surtout présent quand les centres mixtes optique+audio sont équipés en MyEasyOptic).</p>
<p>Le marché de l'audiologie est très <strong>concentré sur Cosium</strong> (44%) mais reste structuré comme un marché de niche : "Autres" (éditeurs marginaux ou non répertoriés) représente encore 37% des centres — c'est l'une des spécialités où les solutions verticales artisanales tiennent face aux grands éditeurs.</p>`,
    trends: `<p>La tendance dominante du marché audioprothésiste, c'est la <strong>consolidation de Cosium</strong> qui est passé de 28,7% à 44,4% en 7 ans (+16 points). Cette croissance se fait au détriment des solutions historiques non répertoriées ("Autres" est passé de 70,6% à 37,5% — soit -33 points), signe d'une professionnalisation et concentration progressive du marché.</p>
<p><strong>IDM Software</strong> a fait son apparition au top en 2021-2022 et capte désormais 11,7% du marché — c'est le challenger principal de Cosium, avec une approche 100% audio (vs Cosium qui couvre aussi l'optique).</p>
<p>Le contexte réglementaire 100% Santé (Reste à Charge Zéro) lancé en 2021 a fortement accéléré la digitalisation des audioprothésistes — les solutions logicielles plus modernes (devis, prise en charge mutuelle automatisée) ont gagné des utilisateurs au détriment des vieilles solutions Excel/Access maison.</p>`,
    faq: [
      {
        ...
        a: "Cosium Center (édité par Cosium) est le logiciel le plus utilisé par les audioprothésistes français en 2026, avec 44,4% des télétransmissions en juin. Il est suivi par IDM Software (11,7%), Optimum Live (5,2%), Intellio Editeurs (0,6%) et MyEasyOptic (0,3%).",
      },
      {
      ...
      },
      {
        ...
        a: "C'est un marché en cours de concentration : Cosium détient 44% des centres, mais 37% utilisent encore des solutions non répertoriées (logiciels propriétaires, Excel maison, etc.). La professionnalisation s'est accélérée depuis le 100% Santé en 2021, et la tendance va vers une consolidation progressive sur 2-3 éditeurs principaux d'ici 2028.",
      },
    ],
  },
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    metaDescription: "Quel logiciel orthoptiste est le plus utilisé en France ? Medi+4000 (Cegedim, 31%), Vega (Epsilog, 15%), Topaze AIR (6%), Orthomax (5%). Classement à jour, GIE SESAM-Vitale.",
    source: 'GIE SESAM-Vitale',
    asOf: 'juin 2026',
    topPlayers: [
      { rank: 1, name: 'Medi+4000', editor: 'Cegedim Santé', share: '30,7%', note: 'leader stable' },
      { rank: 2, name: 'Vega', editor: 'Epsilog', share: '14,7%', note: 'en progression' },
      { rank: 3, name: 'Topaze AIR', editor: 'Sofia Développement', share: '6,0%', note: 'gamme cloud, +0,7 pt au T2 2026' },
      { rank: 4, name: 'Orthomax', editor: 'Sofia Développement', share: '4,8%' },
      { rank: 5, name: 'Acteur.fr', editor: 'Aatlantide', share: '4,2%' },
    ],
    marketAnalysis: `<p>Le logiciel orthoptiste le plus utilisé en France est <strong>Medi+4000</strong>, édité par <strong>Cegedim Santé</strong>, avec <strong>30,7%</strong> des télétransmissions en juin 2026. C'est le leader stable du marché depuis plus de 10 ans, avec une part qui s'est légèrement érodée (-5 points depuis 2019) mais qui reste très majoritaire.</p>
<p>Le top 5 est complété par <strong>Vega</strong> (Epsilog, 14,7% — en progression), <strong>Topaze AIR</strong> (Sofia Développement, 6,0% — la nouvelle gamme cloud, +0,7 point sur le 2e trimestre 2026 où elle passe seule 3e), <strong>Orthomax</strong> (Sofia Développement, 4,8%) et <strong>Acteur.fr</strong> (Aatlantide, 4,2%). Au cumul, ces 5 solutions couvrent environ 60% du marché orthoptiste.</p>
<p>Côté éditeurs, <strong>Cegedim Santé</strong> reste dominant avec Medi+4000 (31%). <strong>Sofia Développement</strong> arrive en deuxième position avec ~10% via Orthomax + Topaze AIR. Une particularité du marché : "Autres" (éditeurs hors top 10) représente 21% — signe d'une fragmentation forte avec de nombreux éditeurs spécialisés dans la rééducation visuelle.</p>`,
    trends: `<p>Le marché orthoptiste évolue lentement comparé à d'autres spécialités. <strong>Medi+4000</strong> reste leader mais perd doucement du terrain (-5 points en 7 ans). Les principaux gagnants en parts de marché sont les éditeurs de "petite niche" — la catégorie "Autres" est passée de 9,5% à 21,4% (+12 points), signe que le marché se diversifie vers de nouveaux éditeurs verticaux.</p>
...
<p>Tendance à surveiller : les orthoptistes sont une <strong>profession en forte croissance démographique</strong> en France (les nouveaux installés sont nombreux), ce qui crée de l'opportunité pour les éditeurs cloud-first qui captent les jeunes praticiens. Sofia Développement avec Topaze AIR semble bien positionné sur cette dynamique.</p>`,
    faq: [
      {
        ...
        a: "Medi+4000 (édité par Cegedim Santé) est le logiciel le plus utilisé par les orthoptistes français en 2026, avec 30,7% des télétransmissions en juin. Il est suivi par Vega (Epsilog, 14,7%), Topaze AIR (Sofia Développement, 6,0%), Orthomax (Sofia, 4,8%) et Acteur.fr (Aatlantide, 4,2%).",
      },
      {
        q: 'Vega est-il adapté aux orthoptistes ?',
        a: "Oui, Vega d'Epsilog est utilisé par 14,7% des orthoptistes français. C'est le logiciel polyvalent le plus utilisé pour les paramédicaux libéraux (kiné, infirmier, orthophoniste, orthoptiste) — il s'adapte aux besoins métier avec des modules spécifiques.",
      },
      {
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    metaDescription: "Quel logiciel sage-femme est le plus utilisé en France ? MaieuticApp (FT Labs, 24%), Weda (18%), Medi+4000 (Cegedim, 13%), Acteur.fr (9%). Classement à jour.",
    source: 'GIE SESAM-Vitale',
    asOf: 'juin 2026',
    topPlayers: [
      { rank: 1, name: 'MaieuticApp', editor: 'FT Labs', share: '24,3%', note: 'spécialisé sage-femme, +1,3 pt au T2 2026' },
      { rank: 2, name: 'Weda', editor: 'Vidal France', share: '17,9%', note: 'forte progression' },
      { rank: 3, name: 'Medi+4000', editor: 'Cegedim Santé', share: '13,5%' },
      { rank: 4, name: 'Acteur.fr', editor: 'Aatlantide', share: '8,9%', note: 'ex-leader' },
      { rank: 5, name: 'Simply-Vitale', editor: 'Cegedim Santé', share: '8,2%' },
    ],
    marketAnalysis: `<p>Le logiciel sage-femme le plus utilisé en France est <strong>MaieuticApp</strong>, édité par <strong>FT Labs</strong>, avec <strong>24,3%</strong> des télétransmissions en juin 2026 — et il continue de creuser l'écart (+1,3 point sur le seul 2e trimestre 2026). C'est un nouvel entrant 100% spécialisé sage-femme arrivé sur le marché en 2020-2021, qui est devenu leader en moins de 5 ans grâce à une UX adaptée au métier (suivi grossesse, suivi gynéco, échographies).</p>
<p>Le top 5 est complété par <strong>Weda</strong> (Vidal France, 17,9% — forte progression), <strong>Medi+4000</strong> (Cegedim Santé, 13,5%), <strong>Acteur.fr</strong> (Aatlantide, 8,9% — l'ex-leader historique) et <strong>Simply-Vitale</strong> (Cegedim Santé, 8,2%). Ensemble ces 5 solutions couvrent 73% du marché.</p>
<p>Si on cumule par éditeur, le marché est partagé entre <strong>Vidal France</strong> (Weda, 17,9% — cloud moderne) et <strong>Cegedim Santé</strong> (~22% via Medi+4000 = polyvalent éprouvé, et Simply-Vitale = mobile). FT Labs (MaieuticApp) reste le seul concurrent majeur 100% spécialisé sage-femme.</p>`,
    trends: `<p>Le marché sage-femme a connu un <strong>renversement spectaculaire</strong> en 7 ans. En 2019, le trio de tête était <strong>Intellio</strong> (Orisha, 21,8%), <strong>Medi+4000</strong> (18,4%) et <strong>Acteur.fr</strong> (18,1%). En 2026, Intellio s'est effondré (-14 points → 7,1%) et Acteur.fr a aussi fortement reculé (-9 points → 8,9%).</p>
<p>Les grands gagnants : <strong>MaieuticApp</strong> (FT Labs, +24 points en 5 ans — partant de zéro) et <strong>Weda</strong> (+18 points — partant de zéro aussi). Ces deux solutions cloud modernes ont profité de la lassitude des sages-femmes envers les logiciels génériques pour capter le marché avec des fonctionnalités métier dédiées (terme grossesse, suivi prénatal, courrier de naissance).</p>
<p>La leçon : sur les <strong>petites spécialités libérales</strong> (sage-femme, podologue, orthoptiste), il y a de la place pour des éditeurs verticaux 100% spécialisés. MaieuticApp en est l'illustration parfaite — un logiciel pensé "pour les sages-femmes par des sages-femmes" peut prendre le marché en 4-5 ans face aux mastodontes généralistes.</p>`,
    faq: [
      {
        ...
        a: "MaieuticApp (édité par FT Labs) est le logiciel le plus utilisé par les sages-femmes libérales françaises en 2026, avec 24,3% des télétransmissions en juin. Il est suivi par Weda (Vidal France, 17,9%), Medi+4000 (Cegedim, 13,5%), Acteur.fr (8,9%) et Simply-Vitale (8,2%).",
      },
      {
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    metaDescription: "Quel logiciel podologue est le plus utilisé en France ? Medi+4000 (Cegedim, 25%), Intellio (Orisha, 6%), Televitale (Sofia, 6%). Marché fragmenté, données GIE SESAM-Vitale.",
    source: 'GIE SESAM-Vitale',
    asOf: 'juin 2026',
    topPlayers: [
      { rank: 1, name: 'Medi+4000', editor: 'Cegedim Santé', share: '24,6%', note: 'leader en érosion' },
      { rank: 2, name: 'Intellio', editor: 'Orisha Healthcare France', share: '6,4%' },
      { rank: 3, name: 'Televitale', editor: 'Sofia Développement', share: '6,1%' },
      { rank: 4, name: 'Vital Online', editor: 'Mediconcept', share: '4,0%' },
      { rank: 5, name: 'Andréane', editor: 'Andréane (Centre de Gestion)', share: '1,8%' },
    ],
    marketAnalysis: `<p>Le logiciel pédicure-podologue le plus utilisé en France est <strong>Medi+4000</strong>, édité par <strong>Cegedim Santé</strong>, avec <strong>24,6%</strong> des télétransmissions en juin 2026. C'est le leader historique du marché libéral de la podologie, mais il a perdu près de 11 points en 7 ans (de 35,6% en 2019 à 24,6% en 2026).</p>
<p>Le top 5 est complété par <strong>Intellio</strong> (Orisha Healthcare France, 6,4%), <strong>Televitale</strong> (Sofia Développement, 6,1%), <strong>Vital Online</strong> (Mediconcept, 4,0%) et <strong>Andréane</strong> (1,8%). Le top 5 ne couvre que 43% du marché — c'est l'un des marchés les plus fragmentés de la santé libérale française.</p>
<p>"Autres" (éditeurs hors top 10) représente <strong>47% des cabinets</strong> — la majorité des podologues utilisent donc une solution "longue traîne". Cette particularité s'explique par les besoins très spécifiques du métier (suivi posturologique, semelles orthopédiques, soins du pied diabétique) qui ne sont pas toujours bien couverts par les éditeurs généralistes.</p>`,
    trends: `<p>Le marché podologue est en pleine <strong>fragmentation</strong>. <strong>Medi+4000</strong>, leader historique, a perdu près d'un tiers de sa base (-11 points), au profit principalement de la catégorie "Autres" qui est passée de 21% à 47% (+26 points). Ce n'est pas un autre logiciel qui s'impose, c'est une multitude de petits éditeurs qui captent les utilisateurs déçus.</p>
...
<p>Opportunité : c'est probablement le marché santé libéral le plus <strong>ouvert à un nouvel entrant cloud-first</strong>. Un éditeur qui proposerait un logiciel 100% spécialisé podologie (gestion semelles, suivi diabétique, posturologie) avec une UX moderne pourrait facilement capter 20-30% du marché en quelques années.</p>`,
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    metaDescription: "Quel logiciel centre de santé est le plus utilisé en France ? Intellio Editeurs (Orisha, 24%), Veasy (Visiodent, 17%), Galaxie Soins (Xtrem, 14%), Albus AIR (8%). Classement à jour.",
    source: 'GIE SESAM-Vitale',
    asOf: 'juin 2026',
    topPlayers: [
      ...
      { rank: 3, name: 'Galaxie Soins', editor: 'Xtrem Santé', share: '14,4%', note: 'historique CDS' },
      { rank: 4, name: 'Albus AIR', editor: 'Sofia Développement', share: '8,1%' },
      { rank: 5, name: 'MonLogicielMedical.com', editor: 'Cegedim Santé', share: '6,0%' },
    ],
    marketAnalysis: `<p>Le logiciel le plus utilisé par les centres de santé en France est <strong>Intellio Editeurs</strong>, édité par <strong>Orisha Healthcare France</strong>, avec <strong>24,3%</strong> des télétransmissions en juin 2026. C'est une remontée spectaculaire : Intellio Editeurs ne représentait que 1,6% du marché en 2019.</p>
<p>Le top 5 est complété par <strong>Veasy</strong> (Visiodent, 17,0% — la nouvelle gamme cloud en très forte progression), <strong>Galaxie Soins</strong> (Xtrem Santé, 14,4% — le logiciel historique des centres de santé pluri-professionnels), <strong>Albus AIR</strong> (Sofia Développement, 8,1%) et <strong>MonLogicielMedical.com</strong> (Cegedim Santé, 6,0%).</p>
...
<p>Un facteur clé : la <strong>politique de financement des centres de santé</strong> par l'État (avec exigences de reporting accru) et le développement des centres pluri-professionnels (CPTS, MSP) ont rebattu les cartes. Les centres ont besoin de solutions cloud capables d'agréger les données de tous les praticiens — d'où le succès de Veasy et Intellio Editeurs.</p>`,
    faq: [
      {
        ...
        a: "Intellio Editeurs (Orisha Healthcare France) est le logiciel le plus utilisé par les centres de santé français en 2026, avec 24,3% des télétransmissions en juin. Il est suivi par Veasy (Visiodent, 17,0%), Galaxie Soins (Xtrem Santé, 14,4%), Albus AIR (Sofia, 8,1%) et MonLogicielMedical.com (Cegedim, 6,0%).",
      },
      {
      ...
      },
      {
        ...
        a: "Oui, Galaxie Soins (Xtrem Santé) reste un acteur important du marché centre de santé en France avec 14,4% des structures en juin 2026. C'est le 3e logiciel le plus utilisé, derrière Intellio Editeurs et Veasy. Il est particulièrement implanté dans les CDS historiques (mutuelles, municipaux) qui privilégient sa stabilité.",
      },
    ],
  },
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    metaDescription: "Quel logiciel laboratoire d'analyses biomédicales est le plus utilisé en France ? Hexalis (Dedalus, 31%) leader. Données GIE SESAM-Vitale, classement à jour.",
    source: 'GIE SESAM-Vitale',
    asOf: 'juin 2026',
    topPlayers: [
      { rank: 1, name: 'Hexalis', editor: 'Dedalus Healthcare France', share: '31,0%', note: 'leader stable' },
      { rank: 2, name: 'Clarilab', editor: 'Clarisys Informatique', share: '6,1%' },
      { rank: 3, name: 'Autres (non répertoriés)', editor: 'multiples', share: '63,0%', note: 'longue traîne' },
    ],
    marketAnalysis: `<p>Sur la métrique GIE SESAM-Vitale (télétransmissions des FSE de juin 2026), <strong>Hexalis</strong>, édité par <strong>Dedalus Healthcare France</strong>, ressort à <strong>31,0%</strong>, suivi de <strong>Clarilab</strong> (Clarisys Informatique, 6,1%). Mais cette mesure ne capture qu'une partie du paysage : les FSE renvoyées par chaque progiciel n'incluent ni les autres solutions du même éditeur, ni les modules de facturation déportés vers d'autres briques. En base installée réelle sur les laboratoires de biologie médicale (LBM) de ville, le marché est nettement plus concentré et clairement <strong>oligopolistique</strong>.</p>
...
<p>Le marché logiciel cœur LBM ville pèse environ <strong>60 à 90 M€ par an</strong> (70 à 110 M€ en intégrant l'infogérance, le middleware et la cybersécurité), pour un marché aval des analyses de ville de 4,7 Md€ en 2024 (DREES). La demande est concentrée : selon l'IGAS, <strong>environ 75% des sites</strong> (sur ~4 300 implantations et ~300 entités juridiques) sont contrôlés par <strong>six grands groupes</strong> — Cerba HealthCare, Synlab, Biogroup, Eurofins Biomnis, Inovie, Laborizon.</p>`,
    trends: `<p>Sur les FSE télétransmises (métrique GIE SESAM-Vitale), la grande évolution 2019-2026 est la <strong>disparition de Progimed FSE</strong> (Dedalus), passé de 23,8% à 0% en 7 ans. Dedalus a migré ses utilisateurs Progimed vers Hexalis, qui reste leader stable à 31%. <strong>Clarilab</strong> a plus que doublé sa part (de 2,5% à 6,1%), porté par son positionnement "challenger indépendant" face au géant Dedalus.</p>
...
<p>La catégorie "Autres" à 63% sur la métrique SESAM-Vitale ne reflète donc pas des SI internes de groupes, mais une longue traîne de modules de facturation qui n'identifient pas le SGL d'origine dans les FSE, plus une présence de solutions de niche (middlewares, modules qualité, portails) facturant à part. La structure capitalistique compte évidemment, mais elle se traduit par des <strong>contrats cadres groupes</strong> avec Dedalus, Technidata ou Clinisys, pas par une autonomie logicielle.</p>
<p>Côté dynamique, après un pic post-Ségur (2022-2025), je table sur une croissance logicielle structurelle de <strong>4 à 7% par an</strong> sur 2026-2028, supérieure à celle du marché des examens (1% par an en valeur sur 2014-2024 selon la DREES), tirée par la migration SaaS, la cybersécurité, la consolidation multi-sites et les exigences d'interopérabilité (INS, Mon espace santé, CR-BIO, MSSanté).</p>`,
    faq: [
      ...
      {
        q: "Pourquoi la catégorie 'Autres' représente-t-elle 63% des FSE sur les données SESAM-Vitale ?",
