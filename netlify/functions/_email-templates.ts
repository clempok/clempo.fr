...
export const RESOURCE_CATALOG: ResourceCatalogEntry[] = [
  ...
  {
    id: 'data-specialites',
    slugs: s => s === 'data-download' || !['decideurs-hospitaliers', 'journalistes', 'influenceurs-sante', 'medecins-kols'].includes(s),
    label: {
...
export function resourceAccessUrl(slug: string): string {
  ...
  if (slug === 'medecins-kols') return MEDECINS_KOLS_SHEET_URL
